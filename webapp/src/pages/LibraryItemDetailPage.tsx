          ...
          <div className="flex space-x-4 border-b mb-6">
            {["summary", "flashcards", "mcqs"].map((tab) => (
              <button
                ...
                className={`pb-2 px-2 capitalize border-b-2 ${
                  activeTab === tab
          ...
          {activeTab === "flashcards" && item.flashcards?.length > 0 && (
            <div className="flex flex-col items-center space-y-4">
              ...
              >
                ...
                >
                  <div className="absolute w-full h-full flex items-center justify-center text-center bg-indigo-50 text-lg font-medium border rounded-xl backface-hidden hover:shadow-xl hover:bg-indigo-100 transition duration-300">
                    {flashcard?.question}
                  </div>
                  <div className="absolute w-full h-full flex items-center justify-center text-center bg-indigo-100 text-lg font-medium border rounded-xl backface-hidden rotate-y-180 hover:shadow-xl hover:bg-indigo-200 transition duration-300">
                    {flashcard?.answer}
                  </div>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => {
                    setShowBack(false);
                    setFlashIndex((prev) => Math.min(item.flashcards.length - 1, prev + 1));
                  }}
                      ...
                      {item.mcqs[mcqIndex].options.map((opt) => {
                        ...
                        return (
                          <button
                            ...
                            className={`border px-3 py-2 rounded text-left transition duration-200 ease-in-out transform ${
                              selected
